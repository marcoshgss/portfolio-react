    ...
    return (
      <div id="project" className="my-projects">
        ...
        <div className="my-container">
          ...
          <div className="my-projects-title">
            <a href="https://lp-batman-project.netlify.app/"><img src={batman_Lp} alt="Batman LP - Landing Page" /></a>
          </div>
          <div className="my-projects-title">
          ...
          <div className="my-projects-title">
            <a href="https://clone-pagina-apple-venda.netlify.app/"><img src={pagina_venda_apple} alt="pagina_venda_apple" /></a>
          </div>
          <div className="my-projects-title">
